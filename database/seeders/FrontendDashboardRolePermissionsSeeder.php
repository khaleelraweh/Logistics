...
class FrontendDashboardRolePermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       $frontendRole = Role::create([
        ...
        // Statistics
        $manageStatistics = Permission::create(['name' => 'frontend_dashboard_manage_Statistics', 'display_name' => ['ar'  =>  'إدارة إحصائيات الجامعة',    'en'    =>  'Manage Statistics'], 'route' => 'statistics', 'module' => 'statistics', 'as' => 'statistics.index', 'icon' => 'far fa-calendar-alt', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '140',]);
        $manageStatistics->parent_show = $manageStatistics->id;
        $manageStatistics->save();
        $showStatistics   =  Permission::create(['name'  => 'frontend_dashboard_show_Statistics', 'display_name'       =>  ['ar'   =>  'إحصائيات الجامعة',   'en'    =>  'Statistics'], 'route' => 'statistics', 'module' => 'statistics', 'as' => 'statistics.index', 'icon' => 'far fa-calendar-alt', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
