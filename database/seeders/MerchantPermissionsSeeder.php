...
class MerchantPermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        //===== Packages =====
        //Packages / packages
        $managePackages = Permission::create(['name' => 'manage_packages', 'display_name' => ['ar'  =>  'إدارة الطرود',  'en'    =>  'Manage Packages'], 'route' => 'packages', 'module' => 'packages', 'as' => 'packages.index', 'icon' => 'fas fa-boxes', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '5',]);
