    ...
    public function run(): void
    {
        $rules = [
            [
                ...
                'slug' => ['en'=>'riyadh-local-0-5kg','ar'=>'داخل-الرياض-0-5-كجم'],
            ...
            [
                ...
                'slug' => ['en'=>'outside-riyadh-0-5kg','ar'=>'خارج-الرياض-0-5-كجم'],
            ...
            [
                ...
                'slug'=>['en'=>'remote-areas-0-10kg','ar'=>'المناطق-النائية-0-10-كجم'],
            ...
            [
                ...
                'slug'=>['en'=>'express-delivery','ar'=>'شحن-سريع'],
            ...
            [
                ...
                'slug'=>['en'=>'same-day-delivery','ar'=>'توصيل-نفس-اليوم'],
            ...
            [
                ...
                'slug'=>['en'=>'storage-tier-1','ar'=>'تخزين-المستوى-الأول'],
        ...
        foreach($rules as $rule){
            // إضافة القيم الافتراضية للحقول البوليانية لتجنب NULL
            PricingRule::create(array_merge([
                'oversized' => false,
                'fragile' => false,
                'perishable' => false,
                'express' => false,
