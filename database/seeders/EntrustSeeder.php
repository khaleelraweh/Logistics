...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Payments // payments
        $managePayments = Permission::create(['name' => 'manage_payments', 'display_name' => ['ar'  =>  'إدارة الدفع المالية',  'en'    =>  'Manage Payments'], 'route' => 'payments', 'module' => 'payments', 'as' => 'payments.index', 'icon' => ' fas fa-money-check-alt', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
