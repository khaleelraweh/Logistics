...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Drivers / drivers
        $manageDrivers = Permission::create(['name' => 'manage_drivers', 'display_name' => ['ar'  =>  'إدارة السائقين',  'en'    =>  'Manage Drivers'], 'route' => 'drivers', 'module' => 'drivers', 'as' => 'drivers.index', 'icon' => 'mdi mdi-1 8px mdi-truck-fast-outline', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '40',]);
        $manageDrivers->parent_show = $manageDrivers->id;
        $manageDrivers->save();
        $showDrivers    =  Permission::create(['name' => 'show_drivers',  'display_name' =>   ['ar'   =>  'السائقين',   'en'        =>  'Drivers'], 'route' => 'drivers', 'module' => 'drivers', 'as' => 'drivers.index', 'icon' => 'mdi mdi-1 8px mdi-truck-fast-outline', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        ...
        //Payments // payments
        $managePayments = Permission::create(['name' => 'manage_payments', 'display_name' => ['ar'  =>  'إدارة الدفع المالية',  'en'    =>  'Manage Payments'], 'route' => 'payments', 'module' => 'payments', 'as' => 'payments.index', 'icon' => 'fas fa-external-link-alt', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $managePayments->parent_show = $managePayments->id;
        $managePayments->save();
        $showPayments    =  Permission::create(['name' => 'show_payments',  'display_name' =>   ['ar'   =>  'الدفع المالية',   'en'        =>  'Payments'], 'route' => 'payments', 'module' => 'payments', 'as' => 'payments.index', 'icon' => 'fas fa-external-link-alt', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
