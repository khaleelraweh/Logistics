...
class ShippingPartner extends Model
{
    ...
    protected $guarded = [];
    public $translatable = ['name','slug', 'contact_person', 'description', 'address'];

      protected $searchable = [
        'columns' => [
            'shipping_partners.name' => 10,
            'shipping_partners.contact_person' => 5,
        ]
    ];
    ...
    {
        return $this->hasMany(ExternalShipment::class);
    }
}
