...
class SiteSettingsController extends Controller
{
    ...
    public function show_main_informations()
    {
        ...
        return view('frontend_dashboard.site_infos.index', compact('site_album'));
    }
    ...
    public function update_main_informations(Request $request, $id)
    {
        ...
        return redirect()->route('frontend_dashboard.settings.site_main_infos.show')->with([
    ...
    {
        return view('frontend_dashboard.site_contacts.index');
    }
    ...
    public function update_contact_informations(Request $request, $id)
    {
        ...
        return redirect()->route('frontend_dashboard.settings.site_contacts.show')->with([
            'message' => __('panel.updated_successfully'),
            'alert-type' => 'success'
        ]);
    }
    ...
    {
        return view('frontend_dashboard.site_socials.index');
    }
    ...
    public function update_social_informations(Request $request, $id)
    {
        ...
        return redirect()->route('frontend_dashboard.settings.site_socials.show')->with([
            'message' => __('panel.updated_successfully'),
            'alert-type' => 'success'
        ]);
    }
    ...
    {
        return view('frontend_dashboard.site_metas.index');
    }
    ...
    public function update_meta_informations(Request $request, $id)
    {
        ...
        return redirect()->route('frontend_dashboard.settings.site_meta.show')->with([
            'message' => __('panel.updated_successfully'),
            'alert-type' => 'success'
        ]);
    }
    ...
    {
        return view('frontend_dashboard.site_payment_methods.index');
    }
    ...
    public function update_payment_method_informations(Request $request, $id)
    {
        ...
        return redirect()->route('frontend_dashboard.settings.site_payment_methods.show')->with([
            'message' => __('panel.updated_successfully'),
            'alert-type' => 'success'
        ]);
    }
    ...
    {
        return view('frontend_dashboard.site_counters.index');
    }
    ...
    public function update_site_counter_informations(Request $request, $id)
    {
        ...
        return redirect()->route('frontend_dashboard.settings.site_counters.show')->with([
            'message' => __('panel.updated_successfully'),
            'alert-type' => 'success'
        ]);
    }
