...
namespace App\Http\Livewire\Driver\Profile;
    ...
    public function updateLocaleExternally($locale)
{
    ...
    public function updated($property)
    {
        ...
        $this->emitTo('driver.profile.language-switcher-component', 'updateLocale', $this->locale);
    ...
    {
        return view('livewire.driver.profile.layout-customizer-component');
    }
}
