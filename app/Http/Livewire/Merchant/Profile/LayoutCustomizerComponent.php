...
namespace App\Http\Livewire\Merchant\Profile;
    ...
    public function updateLocaleExternally($locale)
{
    ...
    public function updated($property)
    {
        ...
        $this->emitTo('merchant.profile.language-switcher-component', 'updateLocale', $this->locale);
    ...
    {
        return view('livewire.merchant.profile.layout-customizer-component');
    }
}
