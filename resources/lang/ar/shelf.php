...
return [
    //Index page
    'manage_shelves'              => 'إدارة الرفوف',
    'view_shelves'                => 'إستعراض الرفوف',
    'shelf_data'                 =>  'بيانات الرفوف',
    'shelf_description'          =>  'هذه الصفحة تمكنك من استعراض الرفوف والتجار  والقيام بالعديد من العمليات عليهم',
    'add_new_shelf'              =>  ' إضافة رف جديد',
    'shelves'                =>  'الرفوف',

    //create page
    'shelf_info'                 =>  'معلومات الرف',
    'add_shelf'                  =>  'إضافة رف',
    'edit_shelf'                  =>  'تعديل رف',
    'choose_shelf_status'        =>  'اختر حالة الرف',
    ...
    'shelf_note1' => 'إذا لم يتم اختيار تاريخ بدء وانتهاء لإيجار الرف، فسيتم استخدام التواريخ من الأعلى.',
    'shelf_note2' => 'إذا لم يتم تسعير الرف، فسيتم إعطاؤه سعره الافتراضي.',

    'add_shelves_to_warehouse'  =>  'إضافة رفوف إلى المستودع',
