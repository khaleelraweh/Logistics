<div class="card mb-4">
    ...
    <div id="pickupRequestsFiltersCollapse" class="collapse">
        <div class="card-body">
            <form action="{{ route('admin.pickup_requests.index') }}" method="get">
                <div class="row g-2">
                    ...
                    <div class="col-md-12 d-flex align-items-end mt-3">
                        ...
                        <a href="{{ route('admin.pickup_requests.index') }}" class="btn btn-outline-secondary flex-grow-1">
