                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">{{ __('merchant.edit_merchant') }}</a></li>
                        ...
                        <form action="{{ route('admin.merchants.update' , $merchant->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach (config('locales.languages') as $key => $val)
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="name[{{ $key }}]" class="form-control" id="name[{{ $key }}]" type="text" value="{{ old('name.' . $key , $merchant->getTranslation('name',$key)) }}">
                                        @error('name.' . $key)
                            ...
                            @foreach (config('locales.languages') as $key => $val)
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="address[{{ $key }}]" class="form-control" id="address[{{ $key }}]" type="text" value="{{ old('address.' . $key,$merchant->getTranslation('address',$key)) }}">
                                        @error('address.' . $key)
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            @foreach (config('locales.languages') as $key => $val)
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="contact_person[{{ $key }}]" class="form-control" id="contact_person[{{ $key }}]" type="text" value="{{ old('contact_person.' . $key , $merchant->getTranslation('contact_person',$key)) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="phone" class="form-control" id="phone" type="text" value="{{ old('phone' ,$merchant->phone) }}">
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="input-email" class="form-control input-mask" data-inputmask="'alias': 'email'" name="email" value="{{ old('email' , $merchant->email) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="api_key" class="form-control" id="api_key" type="text" value="{{ old('api_key' , $merchant->api_key) }}">
                                    @error('api_key')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            @foreach (['facebook', 'twitter', 'instagram', 'linkedin', 'youtube', 'website'] as $social)
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="{{ $social }}" class="form-control" id="{{ $social }}" type="url" value="{{ old($social,$merchant->$social) }}">
                                        @error('{{ $socail }}')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-switch" >
                                        <input type="checkbox" class="form-check-input" name="status"  id="customSwitch1"  {{ old('status', $merchant->status) == '1' ? 'checked' : '' }} >
                            ...
                            @ability('admin', 'update_merchants')
                                <div class="text-end">
                                    <button type="submit" class="btn btn-primary">{{ __('merchant.update_merchant_data') }}</button>
                                </div>
                            @endability
