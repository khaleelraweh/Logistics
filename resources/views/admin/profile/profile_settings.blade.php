            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" name="user_image" id="admin_profile_image" class="file-input-overview ">
                            @error('user_image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    @if (auth()->user()->user_image != '')
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('admin.profile.remove_image', ['admin_id' => auth()->user()->id, '_token' => csrf_token()]) }}",
                            key: {{ auth()->user()->id }}
                        }
                    @endif
                ]
