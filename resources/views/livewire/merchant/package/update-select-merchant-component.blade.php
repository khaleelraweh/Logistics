    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="hidden" name="merchant_name" id="merchant_name" value="{{ $merchant_name }}">
            </div>
            <div class="mb-3">
                <strong>{{ __('package.sender_name') }}:</strong>
                <p class="mb-0">{{ $sender_full_name }}</p>
                <input type="hidden" name="sender_full_name" id="sender_full_name" value="{{ $sender_full_name }}">
