                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @ability('driver', 'display_pickup_requests')
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('driver.pickup_requests.show', $request->id) }}">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('driver.pickup_requests.edit', $request->id) }}">
                                                        <i class="fas fa-edit me-2"></i>{{ __('general.edit') }}
                                                    </a>
                                                </li>
                                                @endability

                                                @ability('driver', 'delete_pickup_requests')
                                                ...
                                                <li>
                                                    ...
                                                    <form id="delete-pickup-request-{{ $request->id }}"
                                                        action="{{ route('driver.pickup_requests.destroy', $request->id) }}"
