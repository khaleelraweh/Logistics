    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                ...
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('frontend_dashboard.advertisor_sliders.index') }}">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('frontend_dashboard.advertisor_sliders.update', $advertisorSlider->id) }}" method="post"
                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row ">
                                    <div class="col-sm-12 col-md-2 pt-3">
                                        <label for="subtitle[{{ $key }}]">
                                            ...
                                            <span class="language-type">
                                                <i class="flag-icon flag-icon-{{ $key == 'ar' ? 'sa' : 'us' }} mt-1 "
                                                    subtitle="{{ app()->getLocale() == 'ar' ? 'sa' : 'us' }}"></i>
                                                {{ __('panel.' . $key) }}
                                            </span>
                                        </label>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                ...
                                <a href="{{ route('frontend_dashboard.advertisor_sliders.index') }}" name="submit"
                            ...
                            @foreach ($advertisorSlider->photos as $media)
                                {
                                    ...
                                    url: "{{ route('frontend_dashboard.advertisor_sliders.remove_image', ['image_id' => $media->id, 'slider_id' => $advertisorSlider->id, '_token' => csrf_token()]) }}",
                                    key: {{ $media->id }}
                                },
                            @endforeach
                        @endif
