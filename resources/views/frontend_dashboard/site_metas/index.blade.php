...
@section('style')
    <link rel="stylesheet" href="{{ asset('admin/assets/libs/tag_meta/tag_meta.css') }}">
    <style>
        .tags-container {
            display: block;
            height: 150px;
...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('frontend_dashboard.settings.site_meta.update', 4) }}" method="post">
                @csrf
                ...
                @ability('frontend_dashboard', 'update_site_metas')
                    <div class="row">
                        <div class="col-md-12">
...
@section('script')
    <script src="{{ asset('admin/assets/libs/tag_meta/tag_meta.js') }}"></script>
@endsection
