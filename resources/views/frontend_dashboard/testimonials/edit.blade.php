...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                ...
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('frontend_dashboard.testimonials.index') }}">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('frontend_dashboard.testimonials.update', $testimonial->id) }}" method="post"
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-10 pt-3">
                            ...
                            <a href="{{ route('frontend_dashboard.testimonials.index') }}" name="submit"
                    ...
                    @if ($testimonial->image != '')
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('frontend_dashboard.testimonials.remove_image', ['testimonial_id' => $testimonial->id, '_token' => csrf_token()]) }}",
                            key: {{ $testimonial->id }}
                        }
                    @endif
                ]
