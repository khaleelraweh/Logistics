    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="ml-auto d-none">
                @ability('frontend_dashboard', 'create_main_sliders')
                    <a href="{{ route('frontend_dashboard.main_sliders.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('frontend_dashboard.settings.site_main_infos.update', 1) }}" method="post"
                ...
                @ability('frontend_dashboard', 'update_site_infos')
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    @if ($siteSettings['site_img']->value != null)
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('frontend_dashboard.site_infos.remove_image', ['site_info_id' => $siteSettings['site_img']->id, '_token' => csrf_token()]) }}",
                        ...
                        @foreach ($site_album->photos as $media)
                            {
                                ...
                                url: "{{ route('frontend_dashboard.site_infos.remove_site_settings_albums', ['image_id' => $media->id, 'site_album_id' => $site_album->id, '_token' => csrf_token()]) }}",
                                key: {{ $media->id }}
                            },
                        @endforeach
                    @endif
                    ...
                    @if ($siteSettings['site_logo_large_light']->value != null)
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('frontend_dashboard.site_infos.remove_site_logo_large_light', ['site_info_id' => $siteSettings['site_logo_large_light']->id, '_token' => csrf_token()]) }}",
                    ...
                    @if ($siteSettings['site_logo_small_light']->value != null)
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('frontend_dashboard.site_infos.remove_site_logo_small_light', ['site_info_id' => $siteSettings['site_logo_small_light']->id, '_token' => csrf_token()]) }}",
                    ...
                    @if ($siteSettings['site_logo_large_dark']->value != null)
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('frontend_dashboard.site_infos.remove_site_logo_large_dark', ['site_info_id' => $siteSettings['site_logo_large_dark']->id, '_token' => csrf_token()]) }}",
                    ...
                    @if ($siteSettings['site_logo_small_dark']->value != null)
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('frontend_dashboard.site_infos.remove_site_logo_small_dark', ['site_info_id' => $siteSettings['site_logo_small_dark']->id, '_token' => csrf_token()]) }}",
