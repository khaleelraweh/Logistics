    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                ...
                <ul class="breadcrumb pt-2">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('frontend_dashboard.pages.index') }}">
                            {{ __('panel.show_pages') }}
                        </a>
                    </li>
                </ul>
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('frontend_dashboard.pages.update', $page->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                ...
                                <a href="{{ route('frontend_dashboard.pages.index') }}" name="submit"
                            ...
                            @foreach ($page->photos as $media)
                                {
                                    ...
                                    url: "{{ route('frontend_dashboard.pages.remove_image', ['image_id' => $media->id, 'page_id' => $page->id, '_token' => csrf_token()]) }}",
                                    key: {{ $media->id }}
                                },
                            @endforeach
                        @endif
