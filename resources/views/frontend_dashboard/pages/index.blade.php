...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="ml-auto">
                @ability('frontend_dashboard', 'create_pages')
                    <a href="{{ route('frontend_dashboard.pages.create') }}" class="btn btn-primary">
        ...
        @include('frontend_dashboard.pages.filter.filter')
                                    ...
                                    <div class="dropdown mb-2 ">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="{{ route('frontend_dashboard.pages.edit', $page->id) }}">
                                            ...
                                            <form action="{{ route('frontend_dashboard.pages.destroy', $page->id) }}" method="post"
