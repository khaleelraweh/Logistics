...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="ml-auto">
                @ability('frontend_dashboard', 'create_main_menus')
                    <a href="{{ route('frontend_dashboard.main_menus.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            {{-- filter form part  --}}
            @include('frontend_dashboard.main_menus.filter.filter')
                                        ...
                                        <div class="dropdown mb-2 ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('frontend_dashboard.main_menus.edit', $main_menu->id) }}">
                                                ...
                                                <form action="{{ route('frontend_dashboard.main_menus.destroy', $main_menu->id) }}"
