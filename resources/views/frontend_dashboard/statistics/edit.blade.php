    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                ...
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('frontend_dashboard.statistics.index') }}">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('frontend_dashboard.statistics.update', $statistic->id) }}" method="post"
                        ...
                        @if (auth()->user()->user_image != '')
                            {
                                ...
                                size: '1111',
                                width: "120px",
                                url: "{{ route('frontend_dashboard.statistics.remove_statistic_image', ['statistic_id' => $statistic->id, '_token' => csrf_token()]) }}",
                                key: {{ $statistic->id }}
                            }
                        @endif
                    ]
