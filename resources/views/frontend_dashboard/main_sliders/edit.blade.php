    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                ...
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('frontend_dashboard.main_sliders.index') }}">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('frontend_dashboard.main_sliders.update', $mainSlider->id) }}" method="post"
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md 10 pt-3">
                                ...
                                <a href="{{ route('frontend_dashboard.main_sliders.index') }}" name="submit"
                            ...
                            @foreach ($mainSlider->photos as $media)
                                {
                                    ...
                                    url: "{{ route('frontend_dashboard.main_sliders.remove_image', ['image_id' => $media->id, 'slider_id' => $mainSlider->id, '_token' => csrf_token()]) }}",
                                    key: {{ $media->id }}
                                },
                            @endforeach
                        @endif
