...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            {{-- filter form part  --}}
            @include('frontend_dashboard.main_sliders.filter.filter')
                                        ...
                                        <div class="dropdown mb-2 ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('frontend_dashboard.main_sliders.edit', $main_slider->id) }}">
                                                ...
                                                <form action="{{ route('frontend_dashboard.main_sliders.destroy', $main_slider->id) }}"
