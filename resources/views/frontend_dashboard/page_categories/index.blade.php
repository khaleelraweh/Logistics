...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="ml-auto">
                @ability('frontend_dashboard', 'create_page_categories')
                    <a href="{{ route('frontend_dashboard.page_categories.create') }}" class="btn btn-primary">
        ...
        @include('frontend_dashboard.page_categories.filter.filter')
                                    ...
                                    <div class="dropdown mb-2 ">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="{{ route('frontend_dashboard.page_categories.edit', $page_category->id) }}">
                                            ...
                                            @else
                                                ...
                                                <form
                                                    action="{{ route('frontend_dashboard.page_categories.destroy', $page_category->id) }}"
