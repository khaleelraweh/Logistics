...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="ml-auto">
                @ability('frontend_dashboard', 'create_partners')
                    <a href="{{ route('frontend_dashboard.partners.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            {{-- filter form part  --}}
            @include('frontend_dashboard.partners.filter.filter')
                                        ...
                                        <div class="dropdown mb-2 ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('frontend_dashboard.partners.edit', $partner->id) }}">
                                                ...
                                                <form action="{{ route('frontend_dashboard.partners.destroy', $partner->id) }}"
