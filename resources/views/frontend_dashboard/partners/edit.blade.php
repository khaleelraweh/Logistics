...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                ...
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('frontend_dashboard.partners.index') }}">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('frontend_dashboard.partners.update', $partner->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-2 pt-3">
                                    <label for="description[{{ $key }}]">
                                        ...
                                        <span class="language-type">
                                            <i class="flag-icon flag-icon-{{ $key == 'ar' ? 'sa' : 'us' }} mt-1 "
                                                description="{{ app()->getLocale() == 'ar' ? 'sa' : 'us' }}"></i>
                                            {{ __('panel.' . $key) }}
                                        </span>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-2 pt-3">
                                    <label for="partner_link[{{ $key }}]">
                                        ...
                                        <span class="language-type">
                                            <i class="flag-icon flag-icon-{{ $key == 'ar' ? 'sa' : 'us' }} mt-1 "
                                                partner_link="{{ app()->getLocale() == 'ar' ? 'sa' : 'us' }}"></i>
                                            {{ __('panel.' . $key) }}
                                        </span>
                                    </label>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-10 pt-3">
                            ...
                            <a href="{{ route('frontend_dashboard.partners.index') }}" name="submit"
                    ...
                    @if ($partner->partner_image != '')
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('frontend_dashboard.partners.remove_image', ['partner_id' => $partner->id, '_token' => csrf_token()]) }}",
                            key: {{ $partner->id }}
                        }
                    @endif
                ]
