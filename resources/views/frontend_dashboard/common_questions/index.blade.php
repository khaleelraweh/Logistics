...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="ml-auto">
                @ability('frontend_dashboard', 'create_common_questions')
                    <a href="{{ route('frontend_dashboard.common_questions.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            {{-- filter form part  --}}
            @include('frontend_dashboard.common_questions.filter.filter')
                                        ...
                                        <div class="dropdown mb-2 ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('frontend_dashboard.common_questions.edit', $common_question->id) }}">
                                                ...
                                                <form
                                                    action="{{ route('frontend_dashboard.common_questions.destroy', $common_question->id) }}"
