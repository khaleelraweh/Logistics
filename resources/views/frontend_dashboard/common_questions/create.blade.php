...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                ...
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('frontend_dashboard.common_questions.index') }}">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('frontend_dashboard.common_questions.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md 10 pt-3">
                            ...
                            <a href="{{ route('frontend_dashboard.common_questions.index') }}" name="submit"
