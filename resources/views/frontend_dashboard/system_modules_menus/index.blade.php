        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header py-3 d-flex justify-content-between">
                    <div class="card-naving">
                        <h3 class="font-weight-bold text-primary">
                            ...
                            {{ __('panel.manage_system_modules_menus') }}
                        </h3>
                    ...
                    <div class="ml-auto">
                        @ability('frontend_dashboard', 'create_system_modules_menus')
                            <a href="{{ route('frontend_dashboard.system_modules_menus.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    {{-- filter form part  --}}
                    @include('frontend_dashboard.system_modules_menus.filter.filter')
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @forelse ($system_modules_menus as $system_modules_menu)
                                    <tr>
                                        <td>
                                            {{ $system_modules_menu->title }}
                                            <br>
                                            @if ($system_modules_menu->parent != null)
                                                <small
                                                    style="background: #17a2b8;color:white;padding:1px 3px;border-radius: 5px; font-size:11px">
                                                    {{-- تابع للقائمة: --}}
                                                    <span>{{ $system_modules_menu->parent?->title }}</span>
                                                </small>
                                            @endif
                                        </td>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                            {{ \Carbon\Carbon::parse($system_modules_menu->published_on)->diffForHumans() }}
                                                ...
                                                <div class="dropdown mb-2 ">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item d-flex align-items-center"
                                                            href="{{ route('frontend_dashboard.system_modules_menus.edit', $system_modules_menu->id) }}">
                                                            <i data-feather="edit-2" class="icon-sm me-2"></i>
                                                            <span class="">{{ __('panel.operation_edit') }}</span>
                                                        </a>

                                                        <a href="javascript:void(0);"
                                                            onclick="confirmDelete('delete-system_modules_menu-{{ $system_modules_menu->id }}', '{{ __('panel.confirm_delete_message') }}', '{{ __('panel.yes_delete') }}', '{{ __('panel.cancel') }}')"
                                                            class="dropdown-item d-flex align-items-center">
                                                            <i data-feather="trash" class="icon-sm me-2"></i>
                                                            <span class="">{{ __('panel.operation_delete') }}</span>
                                                        </a>
                                                        <form
                                                            action="{{ route('frontend_dashboard.system_modules_menus.destroy', $system_modules_menu->id) }}"
                                                            method="post" class="d-none"
                                                            id="delete-system_modules_menu-{{ $system_modules_menu->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-copy-text="{{ config('app.url') }}/system_modules_menus/{{ $system_modules_menu->slug }}"
                                                            data-id="{{ $system_modules_menu->id }}" title="Copy the link">
                                                    ...
                                                    <span class="copyMessage" data-id="{{ $system_modules_menu->id }}"
                                                        style="display:none;">
                                                        {{ __('panel.copied') }}
                                                    </span>
                                                </div>
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="float-right">
                                        {!! $system_modules_menus->appends(request()->all())->links() !!}
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
