        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between bg-white p-3 rounded-3 shadow-sm">
                ...
                <div class="d-flex">
                    ...
                    <a href="{{ route('merchant.return_requests.edit', $return_request->id) }}" class="btn btn-primary me-2">
                        <i class="mdi mdi-pencil-outline me-1"></i> {{ __('return_request.edit') }}
                    </a>
                    <a href="{{ route('merchant.return_requests.index') }}" class="btn btn-outline-secondary">
