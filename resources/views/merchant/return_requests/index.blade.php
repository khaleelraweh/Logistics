                    ...
                    <div class="page-title-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('merchant.return_requests.index') }}">{{ __('return_request.manage_return_requests') }}</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-head d-flex justify-content-between">
                        ...
                        <div class="button-items">
                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('merchant.return_requests.create') }}">
                    ...
                    <!-- Filters Section -->
                        @include('merchant.return_requests.filter.filter')
                    <!-- End Filters Section -->
                            ...
                            @forelse ($return_requests as $return_request)
                                <tr>
                                    ...
                                    <td data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        ">
                                        <a href="{{ route('merchant.packages.show', $return_request->package_id) }}">
                                            {{ $return_request->package->tracking_number ?? '-' }}
                                            <br>
                                     ...
                                     <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @ability('merchant', 'show_return_requests')
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('merchant.return_requests.show', $return_request->id) }}">
                                                        <i class="fas fa-eye me-2"></i>{{ __('general.show') }}
                                                    </a>
                                                </li>
                                                @endability

                                                @ability('merchant', 'update_return_requests')
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('merchant.return_requests.edit', $return_request->id) }}">
                                                        <i class="fas fa-edit me-2"></i>{{ __('general.edit') }}
                                                    </a>
                                                </li>
                                                @endability

                                                @ability('merchant', 'delete_return_requests')
                                                ...
                                                <li>
                                                    ...
                                                    <form id="delete-return_request-{{ $return_request->id }}"
                                                        action="{{ route('merchant.return_requests.destroy', $return_request->id) }}"
