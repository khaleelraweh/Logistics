                ...
                <div class="page-title-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('merchant.products.index') }}">{{ __('product.products') }}</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-head d-flex justify-content-between">
                        ...
                        @ability('merchant', 'create_products')
                            <div class="button-items">
                                <a class="btn btn-primary waves-effect waves-light" href="{{ route('merchant.products.create') }}">
                    ...
                    <!-- Filters Section -->
                        @include('merchant.products.filter.filter')
                    <!-- End Filters Section -->
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            @ability('merchant', 'show_products')
                                            <li>
                                                <a class="dropdown-item" href="{{ route('merchant.products.show', $product->id) }}">
                                                    <i class="fas fa-eye me-2"></i>{{ __('general.show') }}
                                                </a>
                                            </li>
                                            @endability

                                            @ability('merchant', 'update_products')
                                            <li>
                                            ...
                                            @ability('merchant', 'delete_products')
                                            ...
                                            <li>
                                                ...
                                                <form id="delete-product-{{ $product->id }}" action="{{ route('merchant.products.destroy', $product->id) }}" method="POST" class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </li>
