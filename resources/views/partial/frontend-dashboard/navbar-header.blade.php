<div class="navbar-header">
    <div class="d-flex">
        ...
        <div class="navbar-brand-box">
            <a href="{{ route('frontend_dashboard.index') }}" class="logo logo-dark">
                <span class="logo-sm">
            ...
            <a href="{{ route('frontend_dashboard.index') }}" class="logo logo-light">
                <span class="logo-sm">
    ...
    <div class="d-flex">
        ...
        @livewire('frontend-dashboard.profile.language-switcher-component')
        ...
        <div class="dropdown d-inline-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="{{ route('frontend_dashboard.profile') }}"><i class="ri-user-line align-middle me-1"></i> {{ __('layout.profile') }}</a>
                <a class="dropdown-item" href="#"><i class="ri-wallet-2-line align-middle me-1"></i> {{ __('layout.wallet') }}</a>
                <a class="dropdown-item d-block" href="{{ route('frontend_dashboard.profile.layout-customizer') }}"><span class="badge bg-success float-end mt-1">11</span><i class="ri-settings-2-line align-middle me-1"></i> {{ __('layout.settings') }}</a>
                <a class="dropdown-item" href="{{ route('frontend_dashboard.lock-screen') }}"><i class="ri-lock-unlock-line align-middle me-1"></i> {{ __("layout.lock_screen") }}</a>
